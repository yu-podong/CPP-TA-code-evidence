...
Subject::Subject(string subName, int subHakjum, string subGrade) :IOInterface(subName, 100) {
	cout << "Subject의 인자있는 생성자 호출\n";
	m_name = subName;
	m_hakjum = subHakjum;
	m_grade = subGrade;
	CalcGPA();
